            ...
            <tbody>
              <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td width="60%" class="user">
                	...
                	<div class="u_info">
                    	<?php if(!empty($vo[user][headimgurl])): ?><p class="name"><a href="<?php echo U('WeixinMessage/person');?>&openid=<?php echo ($vo["FromUserName"]); ?>" ><?php echo ($vo["user"]["nickname"]); ?></a></p>
                        <?php else: ?>
                            <p class="name"><a href="<?php echo U('WeixinMessage/person');?>&openid=<?php echo ($vo["FromUserName"]); ?>" ><?php echo ($vo["openid"]); ?></a></p><?php endif; ?>
